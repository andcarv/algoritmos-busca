...
public  ArrayList<SolucaoNumerica> obterFronteiraIncremental(int n, double inc){
		...
		int tamanhoRepositorio = 1000000;
	...
	public static void main(String[] args) {
		...
		ArrayList<SolucaoNumerica> f = dtlz2.obterFronteiraIncremental(n,0.05);
		
		try {
			PrintStream pp = new PrintStream("DTLZ2-pareto_"+ m   +".txt");
			PrintStream ps = new PrintStream("DTLZ2-solutions_"+ m  +".txt");
