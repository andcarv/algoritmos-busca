...
public class InitializeHyperplanePreserve extends InitializeSwarms {

	
	public HyperplaneReferencePoints hyperplane = null;
	
	public InitializeHyperplanePreserve(MOPSO[] s, Problema p){
		super(s,p);
		ID = "hypp";
	...
	public void initializeSwarms(ArrayList<Solucao> solutions, double box_range) {
		...
		for (int i = 0; i < swarms.length; i++) {
			...
			double[] reference_point =  hyperplane.selectRandomReferencePoint(HyperplaneReferencePoints.EXTREME);
