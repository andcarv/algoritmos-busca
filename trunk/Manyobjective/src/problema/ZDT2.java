...
/**
 * Classe que representa o problema ZTD2
 * @author andre
 *
 */

public class ZDT2 extends Problema {
	 ...
	 * Problema ZDT2 - Codigo do jMetal"
	 */
	...
	/**Codigo do jMetal
	  ...
	  public static void main(String[] args) {
		  ...
		  ArrayList<SolucaoNumerica> f = zdt2.obterFronteira(n, numSol);

		  try{
			  PrintStream ps = new PrintStream("pareto/ZTD2_" + m + "_pareto.txt");
