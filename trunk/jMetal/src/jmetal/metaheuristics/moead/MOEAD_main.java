...
public class MOEAD_main {
  ...
  public static void main(String [] args) throws JMException, SecurityException, IOException, ClassNotFoundException {
	  ...
	  for(int i = 0 ; i< exec; i++){  
		  ...
		  if(prob.toLowerCase().equals("wfg1"))
			  problem = new WFG1("Real", k, l, m);
		  if(prob.toLowerCase().equals("wfg2"))
			  problem = new WFG2("Real", k, l, m);
      ...
      //problem = new OKA2("Real") ;
		  ...
		  algorithm.setInputParameter("maxEvaluations",aval);
		  ...
		  algorithm.setInputParameter("finalSize", pop) ; // used by MOEAD_DRA
		  ...
		  String caminhoDir = "results/" + prob.toUpperCase() + "/" + m + "/" + id +"/" + i;

		  File dir = new File(caminhoDir);
		  dir.mkdirs();

		  population.printObjectivesToFile(caminhoDir + "/"+ id + "_"+ m +"_fronts");
		  logger_.info("Variables values have been writen to file VAR");
		  population.printVariablesToFile(caminhoDir + "/" + id + "_"+ m +"_solutions");      
	  }
