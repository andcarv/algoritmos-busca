 ...
 * principal que cont�m os m�todos e atributos necess�rios para obten��o das
 * regras.
 * 
...
public abstract class ObterRegras {
	...
	// Arraylist que cont�m as regras encontradas pelos algoritmos de obten��o
	// de regras.
	...
	// String que cont�m o nome da classe positiva da execu��o (Ex: positive ou
	// true )
	public String classePositiva;
	// String que cont�m o nome da classe negativa da execu��o (Ex: negative ou
	// false )
	...
	// Vari�vel que indica se vai haver ou n�o impress�o na tela e do log do
	...
	// Array que cont�m informa��es necess�rias para o c�lculo do coeficiente de
	// Jaccard
	...
	/**
	 * M�todo abstrato que deve ser implementado por todo algoritmo de obten��o
	...
	/**
	 * M�todo que preenche a matriz de confus�o multi classe de acordo com as
	...
	public void preencherMatrizConfusaoMultiClasse(
		...
		for (int i = 0; i < dadosTeste.numInstances(); i++) {
			...
			// em caso de n�o haver empate pega-se o primeiro e �nico elemento
	...
	/**
	 * M�todo que percorre a base e verifica quantos exemplos n�o foram cobertos
	...
	public void contarExemplosNaoCobertos(Instances dados) {
		...
		System.out
				.println("N�o cobertos: " + (dados.numInstances() - cobertos));
	...
	/**
	 * M�todo que calcula a m�dia dos valores do objetivos para todas as regras
	 * da fronteira
	 * 
	 * @return
	 */
	...
	/**
	 * M�todo que gera regras iniciais aleat�rias de acordo com a distribui��o
	 * dos valores na base
	 * 
	 * @param atributos
	 ...
	 * @param AUC
	 *            Boolean que indica se s� ir� ocorrer a etapa de avalia��o das
	 *            regras geradas
	 * @param verbose
	 *            Indica se haver� a impress�o do andamento da execu��o ou n�o
	 * @param votacao
	 ...
	 * @throws Exception
	 *             Lan�a execu��oc caso haja algum erro nos arquivos de entrada
	 *             ou sa�da.
	 */
	public void executarFolds(String nomeBase, String caminhoBase,
		...
		// Arquivo de redund�ncia que salva as informa��es das execu��es durante
		// o processo.
			...
			for (int i = 0; i < numFolds; i++) {
				...
				if (regras.isEmpty()) {
					...
					if (AUC) {
						...
						// Como n�o h� c�lculo das medidas, n�o h� o processod e
						// vota��o.
						// Assim a op��o sele��o na grava��o de regras deve ser
						// sempre falsa
	...
	/**
	 * M�todo que divide a execu��o dos em folds em diversas parti��es, junta
	 * todas as regras geradas e testa no arquivo de test. J� esta divindo o
	 * base de treinamento em partes iguais, executando o algoritmo para todas
	 * as parti��es, juntando as regras deixando apenas as regras n�o dominadas.
	 * Falta a parte do c�lculo da AUC no arquivo de teste.
	 * 
	 * @param nomeBase
	 * @param caminhoBase
	 * @param nomeMetodo
	...
	/**
	 * M�todo que instania a votacao de acordo com a definicao do arquivo de
	 * configuracao
	 * 
	 * @param votacao
	 */
	...
	/**
	 * M�todo que recebe um conjunto de regras como par�metro, escolhe as regras
	 * n�o dominadas e preenche o atributo regras, que s�o as regras finais
	...
	/**
	 * * @deprecated M�todo ainda n�o terminado. M�todo que preenche uma matriz
	 * com o coeficient de Jaccard de todas as regras S� deve ser executado
	...
	public void addObjetivos(String[] objs) {
		...
		// Caso os objetivos passados como par�metro n�o existam � definido como
		// default Sens e Spec
		if (objetivos.size() == 0) {
			Sensitividade sens = new Sensitividade();
			objetivos.add(sens);
	...
	/**
	 * M�todo que percorre a base de dados e para cada atributo nominal preenche
	 * a distribui��o dos valores
	 */
	@SuppressWarnings("unchecked")
